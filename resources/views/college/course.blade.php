...
<div class="container mt-5">
        ...
        <form action="{{ route('college.course.store')}}" method="post">
        @csrf
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    <label for="field_name"><strong>Field Name:</strong></label>
                    <input type="text" class="form-control" id="field_name" name="fname" >
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="gpa_limit" name="gpalimit" >
                </div>
            ...
            <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="short_name" name="sname" >
                </div>
                <div class="form-group">
                    <label for="substream"><strong>Substream:</strong></label>
                    <input type="text" class="form-control" id="substream" name="substream" >
                </div>
