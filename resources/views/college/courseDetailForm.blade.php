...
<div class="form-container">
    ...
    <form id="myForm" action="{{ route('coursedetail.store') }}" method="POST">
        ...
        <div class="form-group">
            ...
            <small style="display:block;color:#6b7280;margin-top:4px;margin-bottom:8px;">Add helpful info for both +2 and Bachelor students (eligibility, subjects, GPA, entrance/fees, scholarships, outcomes).</small>
            <textarea id="description" name="description" rows="6" required placeholder="Write a concise, student-friendly description.
